...
<script type="text/javascript">
	...
	function exportExcel() {
		window.open("${pageContext.request.contextPath}/reportAction!doNotNeedSecurity_exportExcel.action", "_blank");
	}
</script>
...
<div id="workrecord_recReport_toolbar">
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-myExcel',plain:true" style="float:left;" onclick="exportExcel();">导出EXCEL</a>
	<div class="datagrid-btn-separator"></div>
	&nbsp;&nbsp;时间：<input name="createtimeStart" data-options="value:getFirstDay()" class="easyui-datebox" editable="false"
		style="width: 155px;" />&nbsp;&nbsp;至&nbsp;&nbsp;<input name="createtimeEnd" value="new Date()" class="easyui-datebox" editable="false"
		style="width: 155px;" /> <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true" onclick="searchReport();">查询</a>
</div>